...
CKEDITOR.dialog.add( 'videoDialog', function( editor ) {;
    return {
        title: editor.lang.videodetector.title,
        minWidth: 400,
        minHeight: 100,
        contents: [
            {
                id: 'tab-basic',
                label: editor.lang.videodetector.basic_settings,
                elements: [
                    {
                        type: 'text',
                        id: 'url_video',
                        label: editor.lang.videodetector.url_video_label,
                        validate: CKEDITOR.dialog.validate.notEmpty( editor.lang.videodetector.empty )
                    }
                ]
            }
        ],
        onOk: function() {
            ...
            p.setAttribute("class", "embed-responsive embed-responsive-16by9");
