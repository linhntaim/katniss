...
class DefaultSeeder extends Seeder
{
    public function run()
    {
        ...
        ThemeWidget::create([
            ...
            'constructing_data' => '{"category_id":"' . $category->id . '","x_locale":{"en":{"name":"Widget named Base Links","description":""},"vi":{"name":"Ví dụ về Công cụ hiển thị Base Links","description":""}}}',
            'active' => true,
            'order' => 1
        ]);
        ThemeWidget::create([
