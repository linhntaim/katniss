    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="margin-bottom">
                <a class="btn btn-primary" href="{{ adminUrl('media-categories/create') }}">
                            ...
                            <tbody>
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ adminUrl('media-categories/{id}/edit', ['id'=> $category->id]) }}">
                                                {{ trans('form.action_edit') }}
                                            </a>
                                            <a href="{{ adminUrl('media-categories/{id}/sort', ['id' => $category->id]) }}">
                                                {{ trans('form.action_sort') }}
                                            </a>
                                            <a class="delete" href="{{ addRdrUrl(adminUrl('media-categories/{id}', ['id'=> $category->id])) }}">
