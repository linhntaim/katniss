...
@section('page_title', trans('pages.admin_processed_learning_requests_title'))
@section('page_description', trans('pages.admin_processed_learning_requests_desc'))
@section('page_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{ adminUrl() }}"><i class="fa fa-home"></i> {{ trans('pages.admin_dashboard_title') }}</a></li>
        <li><a href="{{ adminUrl('processed-learning-requests') }}">{{ trans('pages.admin_learning_requests_title') }}</a></li>
    </ol>
@endsection
@section('lib_styles')
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('label.processed_by') }}</th>
                                    <th>{{ trans('label.processed_at') }}</th>
                            ...
                            <tbody>
                                @foreach($learning_requests as $learning_request)
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="{{ adminUrl('users/{id}/edit', ['id' => $learning_request->processed_by_id]) }}">
                                                {{ $learning_request->processedBy->display_name }}
                                            </a>
                                        </td>
                                        <td>{{ $learning_request->formattedProcessedAt }}</td>
                                        <td>
