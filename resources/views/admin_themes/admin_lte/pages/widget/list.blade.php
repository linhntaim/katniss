            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{ adminUrl('widgets/clone') }}?{{ $rdr_param }}">
                    ...
                    <div class="modal-footer">
                        <button id="clone-modal-button" type="submit" class="btn btn-danger">{{ trans('form.action_confirm') }}</button>
    ...
    <div class="row">
        ...
        @for($i=0;$i<$count_placeholders;$i+=2)
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <ul id="placeholder-{{ $i }}" class="todo-list theme-widget-sortable{{ count($themeWidgets)>0 ? '' : ' theme-widget-empty' }}" data-placeholder="{{ $placeholderName }}">
                    @foreach($themeWidgets as $themeWidget)
                        <li data-widget="{{ $themeWidget->id }}">
                            ...
                            <div class="tools">
                                ...
                                <a class="delete" href="{{ adminUrl('widgets/{id}/delete', ['id'=> $themeWidget->id]) }}?{{ $rdr_param }}">{{ trans('form.action_delete') }}</a>
                            </div>
                        </li>
                    @endforeach
                    </ul>
