...
return [
    ...
    'admin/pages/{id}/delete'                       => 'admin/pages/{id}/delete',
    'admin/pages/add'                               => 'admin/pages/add',
    'admin/pages/{id}/edit'                         => 'admin/pages/{id}/edit',
    'admin/pages/update'                            => 'admin/pages/update',
    'admin/article-categories'                      => 'admin/article-categories',
    'admin/article-categories/add'                  => 'admin/article-categories/add',
    'admin/article-categories/{id}/edit'            => 'admin/article-categories/{id}/edit',
    'admin/article-categories/update'               => 'admin/article-categories/update',
    'admin/article-categories/{id}/delete'          => 'admin/article-categories/{id}/delete',
    'admin/articles'                                => 'admin/articles',
    'admin/articles/{id}/delete'                    => 'admin/articles/{id}/delete',
    'admin/articles/add'                            => 'admin/articles/add',
    'admin/articles/{id}/edit'                      => 'admin/articles/{id}/edit',
    'admin/articles/update'                         => 'admin/articles/update',
];