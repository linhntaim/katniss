...
return [
    ...
    */
    ...
    'alpha_dash' => ':attribute phải có giá trị chỉ gồm chữ cái, chữ số, dấu gạch ngang và dấu gạch dưới.',
    ...
    'gt' => [
        ...
        'file' => ':attribute phải có kích thước tập tin lớn hơn :value kilobytes.',
        'string' => ':attribute phải có độ dài lớn hơn :value ký tự.',
        'array' => ':attribute phải có số lượng các phần tử nhiều hơn :value.',
    ],
    'gte' => [
        'numeric' => 'The :attribute phải có giá trị lớn hơn hoặc bằng :value.',
        'file' => ':attribute phải có kích thước tập tin lớn hơn hoặc bằng :value kilobytes.',
        'string' => ':attribute phải có độ dài lớn hơn hoặc bằng :value characters.',
        'array' => ':attribute phải có số lượng các phần tử nhiều hơn hoặc bằng :value.',
    ],
    ...
    'ipv4' => ':attribute phải có giá trị là địa chỉ IPv4 hợp lệ.',
    'ipv6' => ':attribute must có giá trị là địa chỉ IPv6 hợp lệ.',
    'json' => ':attribute must có giá trị là chuỗi JSON hợp lệ.',
    'lt' => [
        'numeric' => ':attribute phải có giá trị nhỏ hơn :value.',
        'file' => ':attribute phải có kích thước tập tin nhỏ hơn :value kilobytes.',
        'string' => ':attribute phải có độ dài nhỏ hơn :value ký tự.',
        'array' => ':attribute phải có số lượng các phần tử ít hơn :value.',
    ],
    'lte' => [
        'numeric' => 'The :attribute phải có giá trị nhỏ hơn hoặc bằng :value.',
        'file' => ':attribute phải có kích thước tập tin nhỏ hơn hoặc bằng :value kilobytes.',
        'string' => ':attribute phải có độ dài nhỏ hơn hoặc bằng :value characters.',
        'array' => ':attribute phải có số lượng các phần tử ít hơn hoặc bằng :value.',
    ],
    'max' => [
    ...
    'not_regex' => ':attribute có giá trị với định dạng không hợp lệ.',
