...
namespace Katniss\Models\Themes\Plugins\AnalyticServices;

use Katniss\Models\Helpers\AssetHelper;
use Katniss\Models\Helpers\HtmlTag\Html5;
use Katniss\Models\Themes\Extension as BaseExtension;
...
mixpanel.init(\'' . $this->mixPanelToken . '\');';
    ...
    {
        $result = parent::save($data, $localizedData); // TODO: Change the autogenerated stub
